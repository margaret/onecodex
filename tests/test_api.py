...
class TestExtendedApi(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.classification_one = resource_string(__name__, "data/api/{}.json".format(self.uuid_one))  # noqa
        self.table_one = resource_string(__name__, "data/api/{}_table.json".format(self.uuid_one))  # noqa

        self.classification_two = resource_string(__name__, "data/api/{}.json".format(self.uuid_two))  # noqa
        self.table_two = resource_string(__name__, "data/api/{}_table.json".format(self.uuid_two))  # noqa
    ...
    def test_classification_abundance_data(self):
        ...
        classification = self.api.Classifications(self.uuid_one)
    ...
    def test_classification_otu(self):
        ...
        classification_one = self.api.Classifications(self.uuid_one)
        classification_two = self.api.Classifications(self.uuid_two)
...
class TestQueryInterface(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.complete_analyses = resource_string(
            __name__, "data/api/complete_analyses.json")

        self.incomplete_analyses = resource_string(
            __name__, "data/api/incomplete_analyses.json")

        self.sample = resource_string(__name__, "data/api/sample.json")
        self.metadata = resource_string(__name__, "data/api/metadata.json")

        self.uuid_one = "1"
        self.analysis_one = resource_string(
            __name__, "data/api/complete_analysis_one.json")

        self.uuid_two = "2"
        self.analysis_two = resource_string(
            __name__, "data/api/complete_analysis_two.json")

        self.uuid_three = "3"
        self.analysis_three = resource_string(
            __name__, "data/api/incomplete_analysis_one.json")
    ...
    def test_where(self):
        ...
        # old way
        old_complete_analyses = self.api.Analyses.instances(where={"complete": True})  # noqa
        ...
        # old way
        old_incomplete_analyses = self.api.Analyses.instances(where={"complete": False})  # noqa
